 ...
 * flattened.
 * The generated schema-specific store declares synchronous whole-array and
 * half-open-range filling methods using each accessor's exact name and a source
 * array corresponding to its resolved return type.
 *
